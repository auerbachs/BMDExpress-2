...
import org.hamner.common.util.NumberCollator;

/**
 * The class of ArrayAnnotation
 *
 * Input chip name, all probes
 * Matched all probes to genes and symbols
 *
...
public class ArrayAnnotation {
    ...
    private String[][] columnNames = {
         {"Probe Set ID", "Enrez Genes", "Gene Symbols"},
     ...
     *
     * Assign probe2GeneHash and gene2ProbeHash objects
     ...
     * Need Override by subclass
     *
     * For annotation of gene2SymbolHash
    public void arrayGenesSymbols() {
    }

    public Integer probeIndexObject(String probe) {
        return probesHash.get(probe);
    }

    public int indexOfProbe(String probe) {
        return probesHash.get(probe).intValue();
    }
     */
