...
public class NumberManager {
    ...
    private static final double[] DEFAULTS = {0.1,
                                              0.01,
                                              0.001,
                                              0.0001,
                                              0.00001,
    ...
    public static double doubleValue(Object obj) {
        if (obj != null) {
            try {
                ...
                } else if (obj instanceof Integer) {// in case of Integer
     ...
     *
     *  In case the absolute value of a double < 0
     *  then keep at least decimals no-zero digits
     *
     */
