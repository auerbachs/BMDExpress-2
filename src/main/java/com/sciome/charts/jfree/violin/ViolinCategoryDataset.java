...
public class ViolinCategoryDataset extends AbstractDataset
implements BoxAndWhiskerCategoryDataset, RangeInfo, PublicCloneable {
     ...
     *
     * @see #add(ViolinItem, Comparable, Comparable)
     */
     ...
     */
    public void add(ViolinItem item, Comparable rowKey,
     ...
     * @return The item.
     */
    public ViolinItem getItem(int row, int column) {
        return (ViolinItem) this.data.getObject(row, column);
    }
    ...
    public Number getMeanValue(int row, int column) {
        ...
        Number result = null;
        ViolinItem item = (ViolinItem) this.data.getObject(row,
                column);
        if (item != null) {
            result = item.getMean();
        }
    ...
    public Number getMeanValue(Comparable rowKey, Comparable columnKey) {
        Number result = null;
        ViolinItem item = (ViolinItem) this.data.getObject(
                rowKey, columnKey);
        if (item != null) {
            result = item.getMean();
        }
    ...
    public Object clone() throws CloneNotSupportedException {
    	ViolinCategoryDataset clone
                = (ViolinCategoryDataset) super.clone();
