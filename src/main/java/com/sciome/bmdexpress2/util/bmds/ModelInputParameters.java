...
public class ModelInputParameters
{
	...
	public void setBMDSMajorVersion(String string)
	{
		BMDSMajorVersion = string;

	}

	public void setMAMethod(String string)
	{
		MAMethod = string;

	}

	public String getBMDSMajorVersion()
	{
		return BMDSMajorVersion;
	}
