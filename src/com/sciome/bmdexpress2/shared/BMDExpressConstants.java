...
public class BMDExpressConstants
{
	...
	public final String[] TYPES = { "Update Annotations From Web", "Update Annotations From File" };;

	public final String[] ANNOTFILES = { "probe2gene.gz", "genes2gos.gz", "genes2symbols.gz" };;
	...
	public final String[] KEGGFILES = { "taxonomy.KEGG", "map_title.tab.gz", "_gene_map.tab.gz" };
	...
	public final String[] GO_CATEGORIES = { "universal", "biological_process", "molecular_function",
			"cellular_component" };
