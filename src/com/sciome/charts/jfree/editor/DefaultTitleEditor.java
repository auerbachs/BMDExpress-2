...
class DefaultTitleEditor extends JPanel implements ActionListener {
    ...
    public void attemptFontSelection() {
        ...
        int result =
            JOptionPane.showConfirmDialog(
                new FrontDialog(this), panel, localizationResources.getString("Font_Selection"),
    ...
    public void attemptPaintSelection() {
        ...
        Color c = JColorChooser.showDialog(
            new FrontDialog(this), localizationResources.getString("Title_Color"), defaultColor
        );
        if (c != null) {
